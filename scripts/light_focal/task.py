    ...
    def training_step(self, batch, batch_idx):
        ...
        if batch_idx % self.cfg['optim']['log_intervel'] == 0:
            ...
            msg = msg.format(
                ...
                qfl.item() / self.trainer.num_gpus,
                dlf.item() / self.trainer.num_gpus,
                lr,
                int(gt_num.item()))
            self.info(msg)
        return loss
